...
namespace RMSDemo.Controllers
{
    ...
    public class AddDeviceController : BaseController
    {
        ...
        [HttpPost]
        public void UpdateRegisteredDevice(int Id, string Name, string DeviceId, string IMEI, string ModelId, bool Enabled, string MotorEfficiency, string Head,
        ...
        {
            Service Service = new Service();
            var DeviceUpdated = Service.UpdateRegisteredDevice(Id, Name, DeviceId, IMEI, ModelId, Enabled, MotorEfficiency, Head, MotorPower, MotorControl, BenificiaryName, WorkOrderNo, District, Phone, VFD, Address);
        }
